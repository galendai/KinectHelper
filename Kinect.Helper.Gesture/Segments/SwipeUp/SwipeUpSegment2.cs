...
namespace Kinect.Helper.Gestures.Segments
{
    /// <summary>
    ...
    public class SwipeUpSegment2 : IRelativeGestureSegment
    {
        ...
        public GesturePartResult CheckGesture(Skeleton skeleton, Microsoft.Kinect.Toolkit.Interaction.InteractionHandPointer interactionHandPointer)
        {
            return GesturePartResult.NotAvaliable;
        }
    }
}